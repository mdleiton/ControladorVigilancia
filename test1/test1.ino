...
/*
 * Esta funcion revisa el pin de encende de led de cada uno de los sensores
 * conectados al arduino y alguno esta encendido entonces retorna el id del sensor.
 */
int movimientoDetector(){
  //if(pinx) return 1;
  //if(piny) return 2;
  //if(pinz) return 3;
  //return 0;
...
void loop(){
  // inicializar wifi
  // callback o monitorear sensor de movimiento
  int idSensor = movimientoDetector();
  ...
  // si algun sensor de movimiento detecto algo. tomar todo
  if(idSensor > 0){
    captureImg(320, 240);
    // se debe enviar a a un end-point.
  }
